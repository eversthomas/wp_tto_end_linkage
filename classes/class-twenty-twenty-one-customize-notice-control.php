...
class Twenty_Twenty_One_Customize_Notice_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<div class="notice notice-warning">
			<p><?php esc_html_e( 'To access the Dark Mode settings, select a light background color.', 'wp_tto_end_linkage' ); ?></p>
			<p><a href="https://wordpress.org/support/article/twenty-twenty-one/">
				<?php esc_html_e( 'Learn more about Dark Mode.', 'wp_tto_end_linkage' ); ?>
			</a></p>
		</div>
		<?php
	}
