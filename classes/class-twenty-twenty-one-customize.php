		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'wp_tto_end_linkage' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'wp_tto_end_linkage' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'wp_tto_end_linkage' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'wp_tto_end_linkage' ),
						'full'    => esc_html__( 'Full text', 'wp_tto_end_linkage' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new Twenty_Twenty_One_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'wp_tto_end_linkage' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
